/*
  # Stripe Integration Complete Schema
  ...
  1. New Tables
    ...
    - `credit_transactions`: Tracks all credit additions and deductions
  ...
  4. Credit System
    ...
    - Support for purchases, renewals, usage, refunds, and bonuses
    - Automatic credit accumulation on subscription renewals
*/
