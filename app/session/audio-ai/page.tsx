        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
          <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-4">
              {timeExceeded ? 'Session Ended - Tokens Exhausted' : 'No Tokens Available'}
            </h1>
            <p className="text-gray-700 mb-6">
              {timeExceeded
                ? 'Your session was ended because you ran out of available tokens. Upgrade your plan to continue coaching sessions.'
                : 'You\'ve used all your available tokens for this month. Upgrade your plan to continue coaching sessions.'
              }
            </p>
        ...
        <div className="flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-8 min-h-[calc(100vh-4rem)]">
          ...
          {timeExceeded && (
            <Alert className="mb-6 w-full max-w-2xl">
              ...
              <AlertDescription>
                Your session will end soon due to token limits. Please wrap up your conversation.
              </AlertDescription>
            </Alert>
          )}
      ...
      <div className="flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-12 min-h-[calc(100vh-4rem)]">
        <div className="mb-8 w-full max-w-2xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4 text-center">
            Start Audio Session with {selectedCoach.name}
          </h1>
          <p className="text-xl text-gray-600 text-center">
            Get ready for your AI voice coaching session.
          </p>
        </div>
            ...
            <CardContent className="text-center space-y-6">
              ...
              >
                {micPermission === 'requesting' ? (
                  ...
                  <>
                    <Play className="w-4 h-4 mr-2" />
                    {canStartSession() ? 'Start Voice Session' : 'No Tokens Available'}
                  </>
                )}
              </Button>
