...
// OpenAI API integration using server actions for goal extraction from coaching session transcripts
...
export async function extractGoalsFromTranscriptAction(transcript: string): Promise<GoalExtractionResponse> {
...
export async function isOpenAIConfiguredAction(): Promise<boolean> {
